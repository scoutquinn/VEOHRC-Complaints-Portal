...
},{"process":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/foundation-sites/dist/js/foundation.esm.js":[function(require,module,exports) {
"use strict";
    ...
    $elem.on(eventType, function leaveHandler(e) {
      ...
      setTimeout(function leaveEventDebouncer() {
        if (e.relatedTarget === null && leaveWindow && document.hasFocus && document.hasFocus()) {
          (0, _jquery.default)(document).one('mouseenter', function reenterHandler(reeenterE) {
...
exports.Foundation = exports.Core = Foundation;
Foundation.util = {
  /**
...
var Keyboard = {
  ...
  handleKey: function handleKey(event, component, functions) {
    ...
    if (typeof commandList.ltr === 'undefined') {
      ...
      if (rtl()) cmds = _jquery.default.extend({}, commandList.ltr, commandList.rtl);else cmds = _jquery.default.extend({}, commandList.rtl, commandList.ltr);
    }
...
function onTouchMove(e) {
  ...
  if (isMoving) {
    ...
    if (dir) {
      ...
      (0, _jquery.default)(this).trigger(_jquery.default.Event('swipe', e), dir).trigger(_jquery.default.Event("swipe".concat(dir), e));
    }
  }
}
...
Triggers.Listeners.Basic = {
  ...
  closeableListener: function closeableListener(e) {
    ...
    if (animation !== '') {
      Motion.animateOut((0, _jquery.default)(this), animation, function () {
  ...
  _createClass(Accordion, [{
    ...
    value: function _init() {
      ...
      this._checkDeepLink = function () {
        ...
        var $anchor = anchor && (0, _jquery.default)(anchor);
        ...
        if (isOwnAnchor) {
          ...
          if (_this2.options.deepLinkSmudge) {
            onLoad((0, _jquery.default)(window), function () {
    ...
    value: function _openTab($target) {
      ...
      (0, _jquery.default)("#".concat(targetContentId)).attr({
        'aria-expanded': true,
        'aria-selected': true
      });
  ...
  _createClass(Drilldown, [{
    ...
    value: function _showMenu($elem, autoFocus) {
      ...
      $submenus.each(function (index) {
        ...
        if (isLastChild === true) {
          (0, _jquery.default)(this).one(transitionend((0, _jquery.default)(this)), function () {
            if (autoFocus === true) {
...
function (_Plugin) {
  ...
  _createClass(SmoothScroll, [{
    ...
    value: function scrollToLoc(loc) {
      ...
      var $loc = (0, _jquery.default)(loc); // Do nothing if target does not exist to prevent errors
...
function (_Plugin) {
  ...
  _createClass(Magellan, [{
    ...
    value: function _events() {
      ...
      _this.onLoadListener = onLoad((0, _jquery.default)(window), function () {
        _this.$element.on({
...
function (_Plugin) {
  ...
  _createClass(OffCanvas, [{
    ...
    value: function _setMQChecker() {
      ...
      this.onLoadListener = onLoad((0, _jquery.default)(window), function () {
  ...
  _createClass(Orbit, [{
    ...
    */
    value: function _setup(element, options) {
      ...
      Touch.init(_jquery.default); // Touch init is idempotent, we just need to make sure it's initialied.
...
function (_Plugin) {
  ...
  _createClass(ResponsiveAccordionTabs, [{
    ...
    value: function _checkMediaQueries() {
      ...
      _jquery.default.each(MenuPlugins$1, function (key, value) {
        _this.$element.removeClass(value.cssClass);
      }); // Add the CSS class for the new plugin
    ...
    value: function _handleMarkup(toSet) {
      ...
      if (toSet === 'accordion') {
        ...
        $panels.each(function (key, value) {
          ...
          var id = (0, _jquery.default)(value).attr('id') || GetYoDigits(6, 'accordion');
...
Foundation.addToJquery(_jquery.default); // Add Foundation Utils to Foundation global namespace for backwards
// compatibility.
...
Touch.init(_jquery.default);
Triggers.init(_jquery.default, Foundation);
...
},{"./scss/style.scss":"scss/style.scss","jquery":"node_modules/jquery/dist/jquery.js","foundation-sites":"node_modules/foundation-sites/dist/js/foundation.esm.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/VEOHRC-Complaints-Portal.e31bb0bc.map